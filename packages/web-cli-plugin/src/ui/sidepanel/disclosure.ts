...
export const DISCLOSURE_WIRING = Object.freeze([
  Object.freeze({ triggerId: 'l0-status-band', targetId: 'topbar', summary: '状态与连接详情' }),
...
export const NEVER_FOLDABLE = Object.freeze(['risk-rail', 'confirm', 'l0-decision', 'ask', 'log', 'composer']);
