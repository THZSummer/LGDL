...
| `dist/sidepanel.js` | **1,132,748 B**（≈1.08 MiB）〔初测 **15.1 KB**；v1 时点 1,068,165 B；V2-2 时点 1,085,389 B；v2 P0 收口 1,110,744 B；**2026-09-13 V2-4 回填实测 1,132,748 B**（来源 `stat -c %s packages/web-cli-plugin/dist/sidepanel.js`；`test/size-baseline.ts` 基线 = 1,132,748 B / ceiling = **1,189,385 B**；历史 1,068,165 / 1,085,389 / 1,110,744 全保留，**以现状为准**）〕 | — | 记录 |
