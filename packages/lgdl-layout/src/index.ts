 ...
 * dependency, only @lgdl/lgdl-core. Same input always outputs the same layout.
 */
import { VIS_SYMBOL, deriveGroups, type DiagramType, type LgdlDocument, type LgdlEdge, type LgdlNode } from '@lgdl/lgdl-core';
