...
import { createOperationApplier } from '@lgdl/web-cli-base';
import { describeOperation, lgdlDispatch, type LgdlOperation } from './operations.js';
import type { LgdlDocument } from '@lgdl/lgdl-core';
import { parseLgdl, groupNodes } from '@lgdl/lgdl-core';

const { applyOperation, applyOperations } = createOperationApplier<LgdlOperation, LgdlDocument>(lgdlDispatch);
