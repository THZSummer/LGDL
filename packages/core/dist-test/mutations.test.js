...
import { addNode, addEdge, removeNode, removeEdge, updateNode, updateEdge, addGroup, removeGroup, serializeLgdl, parseLgdl, exportMermaid, importMermaid, convert, listFormats, } from './index.js';
const BASE = {
    type: 'flowchart',
    title: 'test',
    nodes: [
...
test('exportMermaid state', () => {
    const doc = {
        type: 'state',
        nodes: [
            { id: 'a', label: '待支付', kind: 'state' },
            { id: 'b', label: '已完成', kind: 'end' },
        ],
