...
├── TREE.md          # 本文件 - 目录导航
├── build.md         # 构建报告（R1 = 123~137 / R2 = 138~152，本叶收口）
...
| 文件 | 说明 | 状态 |
|------|------|------|
| build.md | 构建报告：R1（9 op 前五 + SW 执行器 + 两段握手 + 掩码卡 + 凭据回滚）+ R2（form 扩形 / op.perm.request / op.revoke / 三表整体回滚 / 拒绝非死端 / settings 收编 / 逐 op 布线门禁 / S2 断流首验收死端=0 / 体积档位显式升档 512,000→563,200 + 终轮五要素重登记 / SG-2 keep-feasible） | ✅ 存在 |
