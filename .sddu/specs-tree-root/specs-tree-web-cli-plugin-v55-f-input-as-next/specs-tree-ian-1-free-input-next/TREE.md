# Directory: .sddu/specs-tree-root/specs-tree-web-cli-plugin-v55-f-input-as-next/specs-tree-ian-1-free-input-next/

## 目录简介
父规范 §2.2~§2.5 的**新面根因**全部落在本叶：「自由输入」作为 next 选项的形态缺位（`Q-IAN-003`）；next 注册表已是可注...

## 目录结构
```
specs-tree-ian-1-free-input-next/
├── TREE.md          # 本文件 - 目录导航
