...
> **文档版本**: 1.10.0
> **创建日期**: 2026-08-31
> **状态**: 规划中（v0.6.0 已正式发布 2026-09-05；**v0.7 = web-cli-base 完备化〔F-25 v2 + v3 + F-26 v4〕——SDDU 全流程已 validate（2026-09-08）、代码在分支 feature/web-cli-base-v2 待作者合入发布**；作者裁决 2026-09-06：原 v0.7 工程质量与文档对齐内容后移）
